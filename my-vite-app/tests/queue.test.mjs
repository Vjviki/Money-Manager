...
async function upload(failSecond=false,newArrival=false) {
 ...
 const run=new Function('detectedTransactions','queueBusy','apiFetch','API','headers','buildDetectedPayload','DetectedTransaction','setAddingAll','setDetectedTransactions','toast','loadHome','checkDetectedTransactions','console','validateDetected','detectedEdits','rememberDetectedCategory',method+'\nreturn addAllDetectedTransactions();');
